...
import 'package:masters_pms/src/presentation/student/makeSubmission.dart';
...
class _stdDashboardState extends State<stdDashboard>
  ...
  void initState() {
    ...
    submitTask = tasks['Proposal'].first;
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 16.0),
                    child: Text(
                        "${DateFormat("EEEE d'th,' MMMM").format(currentDate)}"),
                  ),
                  SizedBox(height: 25),
                  Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 16.0),
                        ...
                        children: [
                          ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                var task = tasks['Proposal'][index];
                                return InkWell(
                                  onTap: () => task.status == 'current'
                                      ? makeSub(task)
                                      : null,
                                  child: Column(
                                    children: [
